...
from .certificat_mariage_preview import CertificatMariagePreviewDialog


class FenetreCertificatMariageDocument(QWidget):
    ...
    def __init__(self, patient):
        ...
        self.setWindowTitle("Certificat de mariage")
        self.resize(500, 320)
        ...
        titre = QLabel("💍 CERTIFICAT DE MARIAGE")
        titre.setStyleSheet(
    ...
    def ouvrir_apercu(self):
        ...
        self.apercu = CertificatMariagePreviewDialog(
            self.patient,
            nom_arabe,
            date_du_jour
        )
    ...
    def imprimer(self):
        ...
        dialogue = CertificatMariagePreviewDialog(
            self.patient,
            nom_arabe,
            date_du_jour,
            parent=self
