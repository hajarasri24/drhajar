...
from .certificat_mariage_document import FenetreCertificatMariageDocument
from ..core.paths import DATABASE_PATH


class FenetreCertificatMariage(QWidget):
    ...
    def ouvrir_certificat(self, item):
        ...
        self.document = FenetreCertificatMariageDocument(patient)
        self.document.show()
