...
from .certificat_puberte_document import FenetreCertificatPuberteDocument
from ..core.paths import DATABASE_PATH


class FenetreCertificatPuberte(QWidget):
    ...
    def ouvrir_certificat(self, item):
        ...
        self.document = FenetreCertificatPuberteDocument(patient)
        self.document.show()
