...
class CertificatMedicalPreviewDialog(QDialog):
    def __init__(self, patient, jours, date_du_jour="", date_debut="", date_fin="", template_pdf_path=None, parent=None):
        ...
        self.template_pdf_path = template_pdf_path or template_path("certificat_medical.pdf")
