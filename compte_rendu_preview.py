...
class CompteRenduPreviewDialog(QDialog):
    def __init__(self, donnees, chemin_page1="documents/1.pdf", chemin_page2="documents/2.pdf", parent=None):
        super().__init__(parent)

        self.donnees = donnees
        self.chemin_page1 = chemin_page1
        self.chemin_page2 = chemin_page2

        self.pixmap_page1 = self._charger_template_depuis_pdf(chemin_page1)
        self.pixmap_page2 = self._charger_template_depuis_pdf(chemin_page2)
